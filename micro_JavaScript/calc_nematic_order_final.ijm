 ...
 * segmentation masks using FIJI built-in tools. The segmentation
 * Masks were generated from the code in Python. This macro only show 
 ...
 * Fit Elipse was used to fit an ellipse to each segmented cell, while the orientation
 ...
 */
 	//setSlice(frame); //This sets the current frame in the stack
	run("Analyze Particles...", "size=5-3000 circularity=0-0.8 display exclude clear add composite");
...
print("Data has been saved in " + path + " as csv.");
