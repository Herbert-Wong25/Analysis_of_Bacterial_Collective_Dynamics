 ...
 * masks were generated from the code in Python.
 * 
 */
...
for (frame = 1; frame <= 3; frame++){
	...
	//Set the current frame
	 //This sets the current frame in the stack
	setSlice(frame);
...
/* Define the parameters for measurements, including area, centriod,.. 
...
/* For 1.2 and 1.3,  we perform analysis to extract the "Centriod" （i.e., geometric center) 
...
//Print each Sr to log from inspection
	print("Frame " + frame + ", Colony Centroid: ("+ colonyX +","+ colonyY + ")");
